namespace R440O.Parameters
{
    public class B1_1Parameters
    {
        ...
        #region Колодки
        public static bool B1_1КолодкаТЛГпр1_1 = false;
        public static bool B1_1КолодкаТЛГпр1_2 = false;

        public static bool B1_1КолодкаТЛГпр2_1 = false;
        public static bool B1_1КолодкаТЛГпр2_2 = false;

        public static bool B1_1КолодкаТЛГпр3_1 = false;
        public static bool B1_1КолодкаТЛГпр3_2 = false;
        #endregion
        ...
        /// </summary>
        public static bool B1_1КнопкаСкоростьГР = false;

        /// <summary>
        /// Возможные состояния: true, false
        /// </summary>
        public static bool B1_1КнопкаСкоростьАБ_1ТЛФ_К = false;
    }
}
