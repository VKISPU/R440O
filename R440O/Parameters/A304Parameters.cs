namespace R440O.Parameters
{
    public class A304Parameters
    {
        ...
        public static int A304ПереключательВыборСтвола
        {
            get
            {
                return _a304ПереключательВыборСтвола;
            }
            ...
            set
            {
                if (value > 0 && value < 11)
                {
                    _a304ПереключательВыборСтвола = value;
                }
            }
        }
        ...
        public static int A304ПереключательКонтроль
        {
            get
            {
                return _a304ПереключательКонтроль;
            }
            ...
            set
            {
                if (value > 0 && value < 10)
                {
                    _a304ПереключательКонтроль = value;
                }
            }
        }
        ...
        /// </summary>
        public static string[,] A304ЗначенияПереключательКонтроль = { { "ОГ", "-1", "-1" },
            { "СЧЗ", "1", "0" },
            { "ГН2", "1", "0" },
            { "-27В", "-1", "0" },
            { "+5В", "1", "0" },
