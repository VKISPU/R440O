namespace R440O.Parameters
{
    public class A205M_1Parameters
    {
        ...
        public static string A205M_1ПереключательВолнаХ100 { get; set; }
        public static string A205M_1ПереключательВолнаХ10 { get; set; }
        public static string A205M_1ПереключательВолнаХ1 { get; set; }
