...
namespace R440O.R440OForms.BMB
{
    ...
    public static class BMBParameters
    {
        ...
        public static bool ВыполненаПроверкаЧерезМодуляцию
        {
            get
            {
                return БМАПодключенВерно && N18_MParameters.ПереключательПРД == 3 &&
        ...
        public static bool ВыполненоЗамыканиеНаСебяПоДКБМА1
        {
            get
            {
                return БМА1ПодключенВерно && BMA_M_1Parameters.КнопкаШлейфДК == 3;
            }
        }
        ...
        public static Signal ВходнойСигнал
        {
            get
            {
                if (БМА1ПодключенВерно)
                    return BMA_M_1Parameters.ВыходнойСигнал;
                return null;
            }
        }
        ...
        private static bool _сигнал
        {
            get
            {
                return ВыполненоЗамыканиеНаСебяПоДКБМА1 || ВыполненоЗамыканиеНаСебяПоДКБМА1 || ВходнойСигнал != null;
            }
        }
