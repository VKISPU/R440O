namespace R440O.R440OForms.BMB
{
    partial class BMBForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)(this.ЛампочкаРезервВкл)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.ЛампочкаПриемВызова)).BeginInit();
            ...
            this.BMBPanel.Controls.Add(this.ЛампочкаРезервВкл);
            this.BMBPanel.Controls.Add(this.ЛампочкаПриемВызова);
            this.BMBPanel.Controls.Add(this.ИндикаторПриемКоманды);
            this.BMBPanel.Controls.Add(this.ИндикаторНаборКоманды);
            ...
            // ЛампочкаРезервВкл
            // 
            this.ЛампочкаРезервВкл.BackColor = System.Drawing.Color.Transparent;
            this.ЛампочкаРезервВкл.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Center;
            this.ЛампочкаРезервВкл.Location = new System.Drawing.Point(283, 79);
            this.ЛампочкаРезервВкл.Name = "ЛампочкаРезервВкл";
            this.ЛампочкаРезервВкл.Size = new System.Drawing.Size(86, 52);
            this.ЛампочкаРезервВкл.TabIndex = 79;
            this.ЛампочкаРезервВкл.TabStop = false;
            // 
            // ЛампочкаПриемВызова
            // 
            this.ЛампочкаПриемВызова.BackColor = System.Drawing.Color.Transparent;
            this.ЛампочкаПриемВызова.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Center;
            this.ЛампочкаПриемВызова.Location = new System.Drawing.Point(478, 84);
            this.ЛампочкаПриемВызова.Name = "ЛампочкаПриемВызова";
            ...
            this.ИндикаторНаборКоманды.Text = "  ";
            this.ИндикаторНаборКоманды.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
            // 
            // ЛампочкаДк
            // 
            ...
            // 
            this.BMBПереключательНаправление.BackColor = System.Drawing.Color.Transparent;
            this.BMBПереключательНаправление.BackgroundImage = global::R440O.ControlElementImages.toggleType2;
            this.BMBПереключательНаправление.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Center;
            this.BMBПереключательНаправление.FlatAppearance.BorderSize = 0;
            this.BMBПереключательНаправление.FlatAppearance.MouseDownBackColor = System.Drawing.Color.Transparent;
            this.BMBПереключательНаправление.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Transparent;
            this.BMBПереключательНаправление.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            this.BMBПереключательНаправление.Location = new System.Drawing.Point(477, 205);
            this.BMBПереключательНаправление.Name = "BMBПереключательНаправление";
            this.BMBПереключательНаправление.Size = new System.Drawing.Size(65, 65);
            this.BMBПереключательНаправление.TabIndex = 73;
            this.BMBПереключательНаправление.UseVisualStyleBackColor = false;
            this.BMBПереключательНаправление.MouseUp += new System.Windows.Forms.MouseEventHandler(this.BMBПереключательНаправление_MouseUp);
            // 
            // BMBПереключательПодключениеРезерва
            // 
            this.BMBПереключательПодключениеРезерва.BackColor = System.Drawing.Color.Transparent;
            this.BMBПереключательПодключениеРезерва.BackgroundImage = global::R440O.ControlElementImages.toggleType2;
            this.BMBПереключательПодключениеРезерва.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Center;
            this.BMBПереключательПодключениеРезерва.FlatAppearance.BorderSize = 0;
            this.BMBПереключательПодключениеРезерва.FlatAppearance.MouseDownBackColor = System.Drawing.Color.Transparent;
            this.BMBПереключательПодключениеРезерва.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Transparent;
            this.BMBПереключательПодключениеРезерва.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            this.BMBПереключательПодключениеРезерва.Location = new System.Drawing.Point(290, 205);
            this.BMBПереключательПодключениеРезерва.Name = "BMBПереключательПодключениеРезерва";
            this.BMBПереключательПодключениеРезерва.Size = new System.Drawing.Size(65, 65);
            this.BMBПереключательПодключениеРезерва.TabIndex = 72;
            ...
            ((System.ComponentModel.ISupportInitialize)(this.ЛампочкаРезервВкл)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.ЛампочкаПриемВызова)).EndInit();
