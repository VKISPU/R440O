...
{
    public static class C300M_3Parameters
    {
        ...
        public static bool Включен
        {
            get
            {
                return НеполноеВключение &&
                       ((ТумблерУправление && N15Parameters.ТумблерЦ300М3) || (!ТумблерУправление && КнопкиПитание));
            }
        }
        ...
        /// 9 - 480.
        /// </summary>
        public static C300M_3КнопкиВидРаботы КнопкиВидРаботы = new C300M_3КнопкиВидРаботы();

        public class C300M_3КнопкиВидРаботы
        {
        ...
        /// 9 - -12.6.
        /// </summary>
        public static C300M_3КнопкиКонтрольРежима КнопкиКонтрольРежима = new C300M_3КнопкиКонтрольРежима();
        public class C300M_3КнопкиКонтрольРежима
        {
        ...
        public static bool ТумблерУправление
        {
            ...
            set
            {
                ...
                КнопкиПитание = (!value && N15Parameters.ТумблерЦ300М3);
            }
        }
        ...
        public static BroadcastSignal ВходящийСигнал
        {
            get
            {
                return Включен ? A306Parameters.ВыходнойСигнал3 : new BroadcastSignal();
            }
        }
        ...
        public static bool УсловиеПоимкиСигнала(Signal сигнал)
        {
            ...
            return !КнопкаПоиск && Math.Abs(ЗначениеПоиска - ТочкаПоиска(сигнал)) < 2 &&
                N15Parameters.РегуляторУровень > сигнал.Level;
        }
