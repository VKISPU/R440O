...
namespace R440O.R440OForms.K04M_01
{
    static class K04M_01Parameters
    {
        ...
        {
            get { return 65000 + _переключательПрмМгц*1000 + _переключательПрмКгц100*100; }
        }
        ...
        public static int ЧастотаПрд
        {
            get
            {
                return 70000 + _переключательПрдМгц*1000 + _переключательПрдКгц100*100 + _переключательПрдКгц10*10 +
