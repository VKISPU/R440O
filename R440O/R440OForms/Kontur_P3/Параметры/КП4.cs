    ...
    partial class Kontur_P3Parameters
    {
        ...
        public static bool ЛампочкаКП4Канал1
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    ...
                    || НомерКанала == EПереключательПриоритет._0);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал2
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._2);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал3
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._3);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал4
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал5
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._5);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал6
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._6);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал7
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._7);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал8
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._8);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал9
        {
            get
            {
                return ЛампочкаСеть && КнопкаКП4Контроль && КнопкаВызов
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._9);
            }
        }
        #endregion
