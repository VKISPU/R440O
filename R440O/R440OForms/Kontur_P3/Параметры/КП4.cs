    ...
    partial class Kontur_P3Parameters
    {
        ...
        public static bool ЛампочкаКП4Канал1
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    ...
                    || НомерКанала == EПереключательПриоритет._0 || Мигание);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал2
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._2 || Мигание);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал3
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._3 || Мигание);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал4
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._4 || Мигание);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал5
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._5 || Мигание);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал6
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._6 || Мигание);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал7
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._7 || Мигание);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал8
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._8 || Мигание);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал9
        {
            get
            {
                return ЛампочкаСеть && ЗначениеКнопкиКП4Контроль
                    && ТумблерМткПУ == EТумблерМткПУ.МТК
                    && (НомерКанала == EПереключательПриоритет._9 || Мигание);
            }
        }
        #endregion
