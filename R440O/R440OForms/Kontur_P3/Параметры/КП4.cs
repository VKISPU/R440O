namespace R440O.R440OForms.Kontur_P3.Параметры
{
    ...
    partial class Kontur_P3Parameters
    {
        ...
        public static bool ЛампочкаКП4Канал1
        {
            get
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    ...
                    || НомерКанала == EПереключательПриоритет._0 || Мигание)) || ЗанятоКП4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал2
        {
            ...
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    && (НомерКанала == EПереключательПриоритет._2 || Мигание)) || ЗанятоКП4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал3
        {
            ...
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    && (НомерКанала == EПереключательПриоритет._3 || Мигание)) || ЗанятоКП4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал4
        {
            ...
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    && (НомерКанала == EПереключательПриоритет._4 || Мигание)) || ЗанятоКП4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал5
        {
            ...
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    && (НомерКанала == EПереключательПриоритет._5 || Мигание)) || ЗанятоКП4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал6
        {
            ...
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    && (НомерКанала == EПереключательПриоритет._6 || Мигание)) || ЗанятоКП4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал7
        {
            ...
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    && (НомерКанала == EПереключательПриоритет._7 || Мигание)) || ЗанятоКП4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал8
        {
            ...
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    && (НомерКанала == EПереключательПриоритет._8 || Мигание)) || ЗанятоКП4);
            }
        }
        ...
        public static bool ЛампочкаКП4Канал9
        {
            ...
            {
                return ЛампочкаСеть && ((ЗначениеКнопкиКП4Контроль
                    && (НомерКанала == EПереключательПриоритет._9 || Мигание)) || ЗанятоКП4);
            }
        }
        #endregion
