...
namespace R440O.R440OForms.Kontur_P3.Параметры
{
    partial class Kontur_P3Parameters
    {
        ...
        {
            if ((_КнопкаАдресК || _КнопкаПодпись1 || _КнопкаПодпись2 || _КнопкаПодпись3) && !ЛампочкаИнформПринята)
            {
                ИндексГруппы = -1;
                ЗначениеИндексГруппы = "0";
            }
            else
                if (ЛампочкаИнформПринята && КнопкаНаборККНажата)
                {
                    ИндексГруппы = 0;
                ...
                {
                    if (ИнформацияПринята && КнопкаНаборККОтжата)
                    {
